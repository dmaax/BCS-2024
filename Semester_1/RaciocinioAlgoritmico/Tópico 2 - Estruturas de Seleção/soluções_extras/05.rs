// Informe o maior número e o menor número entre dois números quaisquer
...
fn main() {
    ...
    match numero1.partial_cmp(&numero2) {
        Some(std::cmp::Ordering::Greater) => {
            println!("O maior número é {numero1} e o menor número é {numero2}");
        },
        Some(std::cmp::Ordering::Less) => {
            println!("O maior número é {numero2} e o menor número é {numero1}");
        },
